...
const PROJECTS = [
  ...
  },
  {
    ...
    year:'Avril 2026',
    period:'2026',
    tags:['Python','Pydantic','Supabase','GitHub Actions','Claude Haiku','GitHub Pages'],
    kind:'perso',
  ...
  },
  {
    ...
    period:'2024',
    tags:['XGBoost','LightGBM','RandomForest','Scikit-learn','Pandas','Plotly','Jupyter'],
    kind:'academique',
    note:'Classé 1ᵉʳ sur 62 étudiants de la promo E4 — DataScience & IA 2024.',
    highlight:'1ᵉʳ / 62',
  },
  {
    id:'dashboard',
