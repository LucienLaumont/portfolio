      ...
      <div style={{display:'grid', gridTemplateColumns:'1.4fr 1fr', gap:64, marginTop:28, alignItems:'start'}} className="two-col">
        <div>
          ...
          <p style={{fontSize:17, lineHeight:1.65, marginTop:18, maxWidth:580, opacity:0.85}}>
            Je recherche un poste d'Ingénieur IA & Data, sur des systèmes d'IA et d'automatisation, disponible immédiatement en Île-de-France, avec une préférence pour des sujets à impact (énergie, environnement, éducation). En parallèle je développe Cetascope, une plateforme conversationnelle qui rend accessibles les observations de cétacés, une manière concrète de montrer que l'IA peut aussi servir la sensibilisation au vivant.
          </p>
