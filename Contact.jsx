  ...
  return (
    <section id="contact" style={{background:'var(--bg-2)'}}>
      <div className="container" style={{paddingTop:96, paddingBottom:120}}>
        <Marker>Contact · disponible immédiatement</Marker>
        <h2 style={{
        ...
        <p style={{fontSize:18, lineHeight:1.6, maxWidth:560, opacity:0.8, marginBottom:48}}>
          Je suis à l'écoute d'opportunités en CDI/CDD, disponible immédiatement — en Île-de-France. N'hésitez pas à me contacter par email ou via LinkedIn.
        </p>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:24, maxWidth:900}} className="two-col">
          ...
          <a href="https://www.linkedin.com/in/lucien-laumont-39bb29290/" target="_blank" rel="noreferrer" className="golden-shadow-md" style={{
            background:'var(--fg-1)',
            color:'var(--bg-1)',
            padding:32,
            display:'block',
          ...
          >
            ...
            <div style={{fontSize:22, letterSpacing:'-0.3px'}}>/in/lucien-laumont-39bb29290</div>
